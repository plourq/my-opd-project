# Generated by Django 5.2.7 on 2026-03-02 11:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(blank=True, null=True, upload_to='question_images/%Y/%M/d/')),
                ('question_type', models.CharField(choices=[('choice', 'Варианты ответа'), ('text', 'Свободный ответ'), ('matching', 'Сопоставление')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patronymic', models.CharField(blank=True, max_length=128, null=True)),
                ('is_teacher', models.BooleanField(default=False)),
                ('avatar', models.FileField(blank=True, null=True, upload_to='avatars/%Y/%M/d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_groups', models.ManyToManyField(blank=True, null=True, to='api.group')),
